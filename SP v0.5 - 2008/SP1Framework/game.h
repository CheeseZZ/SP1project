...
void renderInventory(std::string Inventory);	//render the inventory and items you have
void updateInventory(std::string Inventory);    //Updates contents of Inventory and monitor item usage
...
void PuzzleT1();			//renders the Trial and error puzzle difficulty 1
