...
void puzzle1Move() {
	...
	if (g_abKeyPressed[K_UP]) {
		gameResult = Puzzle64(0, Puzzle1Map);
		bSomethingHappenened = true;
	}
	else if (g_abKeyPressed[K_DOWN]) {
		gameResult = Puzzle64(1, Puzzle1Map);
		bSomethingHappenened = true;
	}
	else if (g_abKeyPressed[K_LEFT]) {
		gameResult = Puzzle64(2, Puzzle1Map);
		bSomethingHappenened = true;
	}
	else if (g_abKeyPressed[K_RIGHT]) {
		gameResult = Puzzle64(3, Puzzle1Map);
		bSomethingHappenened = true;
	}
